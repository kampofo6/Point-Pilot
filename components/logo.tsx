...
export const Logo = ({
  ...
  return (
    <div className={cn("flex items-center gap-2", className)}>
      {/* Icon part - keeping the original icon design */}

      {/* Text part - "Point Pilot" in primary font */}
      <span
        className={cn(
          "font-sans font-semibold text-lg tracking-tight",
          uniColor
            ? "text-foreground"
            : "bg-gradient-to-r from-[#07DA97] to-[#059669] bg-clip-text text-transparent"
        )}
      >
        Point Pilot
      </span>
